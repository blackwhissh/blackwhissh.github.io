...
function kiddies_scripts()
{
    ...
    wp_enqueue_style('kiddies-style', get_stylesheet_uri(), array(), _S_VERSION);
    ...
    if (kiddies_get_option('enable_dark_mode')) {
        wp_enqueue_style('kiddies-night-style', get_template_directory_uri() . '/assets/css/dark-mode.css', array(), _S_VERSION);
        wp_add_inline_style('kiddies-night-style', kiddies_get_dark_mode_inline_css());
    }

    wp_enqueue_script('kiddies-script', get_template_directory_uri() . '/assets/js/script.js', array(), _S_VERSION, true);
    ...
    if ('ajax_load_on_click' == $pagination_type || 'ajax_load_on_scroll' == $pagination_type):
        wp_enqueue_script('kiddies-load-posts', get_template_directory_uri() . '/assets/js/pagination.js', array(), _S_VERSION, true);
        // Localized variables
        global $wp_query;
