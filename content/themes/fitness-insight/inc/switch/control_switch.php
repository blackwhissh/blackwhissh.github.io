 ...
 * Control - Switch.
 *
 * @package Fitness Insight Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Fitness_Insight_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'fitness-insight-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'fitness-insight-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
